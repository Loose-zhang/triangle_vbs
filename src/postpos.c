    ...
    while (timediff(B2braw.time, time) < 1E-3) {
        ...
        for (i = 0; i < MAXSAT; i++) {
            ...
            if (B2braw.num_PPPB2BINF02 != 0) {
                ...
                if (fabs(timediff(B2braw.nav.B2bssr[i].t0[0], navs.B2bssr[i].t0[0])) < 1E-3) {
            ...
            if (B2braw.num_PPPB2BINF03 != 0) {
                ...
                if (fabs(timediff(B2braw.nav.B2bssr[i].t0[1], navs.B2bssr[i].t0[1])) < 1E-3) {
            ...
            if (B2braw.num_PPPB2BINF04 != 0) {
                ...
                if (fabs(timediff(B2braw.nav.B2bssr[i].t0[2], navs.B2bssr[i].t0[2])) < 1E-3) {
